...
public class BusDAO {
    ...
    public void insertar(Bus b) throws SQLException {
        String sql = "INSERT INTO buses " +
                "(placa, marca, modelo, anio_fabricacion, capacidad_pasajeros, base_asignada, estado, codigo_socio_fk, fecha_ingreso) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection cn = ConexionBD.conectar();
            ...
            ps.setString(9, b.getFechaIngreso());  // ✅ Nuevo campo
    ...
    private Bus mapBusConSocio(ResultSet rs) throws SQLException {
        ...
        // ✅ Mapear fecha_ingreso (puede ser null en registros viejos)
        bus.setFechaIngreso(rs.getString("fecha_ingreso"));
