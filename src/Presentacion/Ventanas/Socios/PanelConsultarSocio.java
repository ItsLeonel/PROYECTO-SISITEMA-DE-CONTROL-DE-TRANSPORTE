...
add(panelSuperior, BorderLayout.NORTH);
    ...
    private JPanel construirPanelResultado() {
        ...
        gbc.gridx = 0;
        gbc.gridy = fila;
        panel.add(crearLabelCampo("Cédula de Ciudadanía:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 0;
        gbc.gridy = fila;
        panel.add(crearLabelCampo("Nombres Completos:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 0;
        gbc.gridy = fila;
        panel.add(crearLabelCampo("Número de Celular:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 0;
        gbc.gridy = fila;
        panel.add(crearLabelCampo("Placa Bus Asociado:"), gbc);
        gbc.gridx = 1;
